...
public class Navigation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expense_naviagtionView = findViewById(R.id.navigate_naviagtionView);
        ...
        viewPager_adapter = new ViewPager_Adapter(this, manager);
        ...
        expense_naviagtionView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.changePortfolio:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        changeActivity(new ChangePortfolio());
                        return true;
                    ...
                    case R.id.changeSavingRule:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Toast.makeText(Navigation.this, "Chaneg saving rule", Toast.LENGTH_SHORT).show();
                        return true;
                    case R.id.exportAll:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Toast.makeText(Navigation.this, "Export all", Toast.LENGTH_SHORT).show();
                        return true;
                    case R.id.deleteAccount:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Toast.makeText(Navigation.this, "Delete Account", Toast.LENGTH_SHORT).show();
                        return true;
                    case R.id.logOut:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Toast.makeText(Navigation.this, "Log out", Toast.LENGTH_SHORT).show();
                        return true;
                    case R.id.aboutUs:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        changeActivity(new AboutApp());
                        return true;
                    case R.id.appRule:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        changeActivity(new AboutApp());
                    ...
                    case R.id.contactUs:
                        drawerLayout.closeDrawer(GravityCompat.START);
                        Toast.makeText(Navigation.this, "Contact us", Toast.LENGTH_SHORT).show();
                        return true;
                }
                return false;
            }
